...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        //need to create matrices that will change the transformation
        
        M1 = RotateZ(-180);
        M1 *= Scale(0.8f);
        M1 *= Translate(0.125f, 0.125f, 0);
        
        M2 = RotateZ(90);
        M2 *= Translate(-1.0f, -1.0f, 0.0);
        
        M3 = Scale(4.0f);
        M3 *= Translate(-0.625f, -0.375f, 0.0);
        
        M4 =  Scale(2.0f);
        M4 *= RotateZ(-45);
        M4 *= Translate(-0.5, -0.146447, 0.0);
